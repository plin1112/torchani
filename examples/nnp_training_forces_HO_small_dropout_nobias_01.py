...
ds.load()
train_dataset, val_dataset = ds.split(0.8)
'''
...
train_dataset, val_dataset  = torchani.data.load_ani_dataset(
    dspath, species_to_tensor, batch_size, rm_outlier=False,
...
H_network = torch.nn.Sequential(
    torch.nn.Linear(128, 160, bias=False),
    torch.nn.CELU(0.1),
...
latest_checkpoint = 'HO_small_do_nobias_forces-training-latest_01.pt'
best_model_checkpoint = 'HO_small_do_nobias_forces-training-best_01.pt'
